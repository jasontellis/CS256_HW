...
class Cluster:
    ...
    def addMember(self, element, distance=0.0):
        ...
        # Updated centroid is the vector sum of all member vectors and is calculated every time a member is added
    ...
    def reComputeCentroid(self):
        """
        Set centroid as Mode of Cluster using Partition around Medoid Algorithm
        :return:
        """
